...
class Admin_Piwik_Controller extends Admin_Controller {
  ...
  private function _get_admin_form() {
    ...
    $piwik_settings->input("installation_url")->label(t('Installation Url (ie. www.my-piwik-installation.com)'))->rules("required|valid_url")->value(module::get_var("piwik", "installation_url"));
